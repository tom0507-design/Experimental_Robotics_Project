...
const string world_file = "./resources/world_Two_panda.urdf";
const string robot_file = "./resources/mmp_panda.urdf";
const string robot1_name = "mmp_panda_1";
const string robot2_name = "mmp_panda_2";
...
const std::string OBJ_JOINT_ANGLES_KEY  = "sai2::cs225a::object::cup::sensors::q";
const std::string OBJ_JOINT_VELOCITIES_KEY = "sai2::cs225a::object::cup::sensors::dq";
...
void simulation(Sai2Model::Sai2Model* robot1, Sai2Model::Sai2Model* robot2, Sai2Model::Sai2Model* object, Simulation::Sai2Simulation* sim, UIForceWidget *ui_force_widget) {
	...
	while (fSimulationRunning) {
		...
		if (fRobotLinkSelect)
			sim->setJointTorques(robot1_name, command_torques + ui_force_command_torques + g1);
		else
			sim->setJointTorques(robot1_name, command_torques + g1);

		if (fRobotLinkSelect)
			sim->setJointTorques(robot2_name, command_torques + ui_force_command_torques + g2);
		else
			sim->setJointTorques(robot2_name, command_torques + g2);
		...
		redis_client.setEigenMatrixJSON(JOINT_ANGLES_KEY, robot1->_q);
		redis_client.setEigenMatrixJSON(JOINT_VELOCITIES_KEY, robot1->_dq);
		redis_client.setEigenMatrixJSON(JOINT_ANGLES_KEY, robot2->_q);
		redis_client.setEigenMatrixJSON(JOINT_VELOCITIES_KEY, robot2->_dq);
		redis_client.setEigenMatrixJSON(OBJ_JOINT_ANGLES_KEY, object->_q); 
		redis_client.setEigenMatrixJSON(OBJ_JOINT_VELOCITIES_KEY, object->_dq); 
